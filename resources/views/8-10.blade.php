        ...
        <div id="tabla-precios">
          ...
          <div id="tabla-precios">
            ...
            <div class="precio-col">
             <div class="precio-col-header">
             <h3>666 MXN</h3>
             <p>PORCHE / PLAY-MOVIL</p>
             </div>
            
            <div class="precio-col-features">
              <center><img src="assets/img/edad/e43.jpg" alt="" width="180" height="180"></center>
                <p>Contiene luces y sonidos</p>
                <p>Carrito a control remoto</p>
             </div>
            ...
            <div class="precio-col">
             <div class="precio-col-header">
             <h3>120 MXN</h3>
             <p>Stars wars- lego / LEGO</p>
             </div>
            
            <div class="precio-col-features">
              <center><img src="assets/img/edad/e44.jpg" alt="" width="180" height="180"></center>
             <p>Figuras de acción armables</p>
             <p>Contine 300 piezas</p>
             </div>
