...
<head>
  ...
  <title>Categorías / Aire libre</title>
    ...
    <br>
     <br>
      ...
      <div id="tabla-precios">
            ...
            <div class="precio-col">
             <div class="precio-col-header">
               ...
               <div class="precio-col-features">
                 <center><img src="assets/img/edad/e2.jpg" alt="" width="180" height="180"></center>
                <p>Carreola para bebé color negro</p>
                <p>Nuevo diseño (3 ruedas) </p>
                </div>
       ...
       <div class="precio-col-features">
         <center><img src="assets/img/edad/e11.jpg" alt="" width="180" height="180"></center>
        <p>Contiene 4 módulos</p>
        <p>Beneficio para el arrastre </p>
        </div>
            ...
            <div class="precio-col">
             <div class="precio-col-header">
                <h3>200 MXN</h3>
                <p>Andador sherlok / CHICCO</p>
                </div>
               
               <div class="precio-col-features">
                 <center><img src="assets/img/edad/e17.jpg" alt="" width="180" height="180"></center>
                <p>Ideal para tus primeros pasos</p>
                <p>Incluye sensores de movimiento</p>
                </div>
            ...
            <div id="tabla-precios">
              ...
              <div class="precio-col">
               <div class="precio-col-header">
                <h3>150 MXN</h3>
                <p> Bicicleta / APACHE </p>
                </div>
               
               <div class="precio-col-features">
                   <center><img src="assets/img/edad/e37.jpg" alt="" width="180" height="180"></center>
                   <p>Inluye rueditas para sostener</p>
