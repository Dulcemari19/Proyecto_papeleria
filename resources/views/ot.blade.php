...
<head>
  ...
  <title>Categorías / Otros juguetes</title>
         ...
         <div id="tabla-precios">
            ...
            <div class="precio-col">
             <div class="precio-col-header">
                <h3>110 MXN</h3>
                <p>Activity pegs / MINILAND</p>
                </div>
               
               <div class="precio-col-features">
                 <center><img src="assets/img/edad/e12.jpg" alt="" width="180" height="180"></center>
                <p>Diferentes formas de circuitos </p>
                <p>Ayuda a la coordinación y movimientos</p>
                </div>
            ...
            <div class="precio-col">
             <div class="precio-col-header">
               ...
               <div class="precio-col-features">
                 <center><img src="assets/img/edad/e15.jpg" alt="" width="210" height="180"></center>
                <p>Cuenta con dos cámaras de aire</p>
                <p>Vinilo muy resitente</p>
                </div>
                ...
                <div id="tabla-precios">
                    ...
                    <div id="tabla-precios">
                        ...
                        <div class="precio-col">
                         <div class="precio-col-header">
                            <h3>120 MXN</h3>
           <p>Perplexus / NATUR-PLAY</p>
           </div>
          
          <div class="precio-col-features">
            <center><img src="assets/img/edad/e42.jpg" alt="" width="210" height="180"></center>
           <p>Juego de destreza metal </p>
           <p> Diferentes tamaños</p>
                        ...
                        <div class="precio-col">
                         <div class="precio-col-header">
                            <h3>250 MXN</h3>
                            <p>Barita mágica / FISHER-PRICE</p>
                            </div>
                           
                           <div class="precio-col-features">
                             <center><img src="assets/img/edad/e45.jpg" alt="" width="180" height="180"></center>
