  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
        <li><a href=" {{ route ('cero' ) }}"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<center>
     <h4>$ {{ $articulo->pre }} MXN / {{ $articulo->marca }}</h4><br>
     
    <table>
    <tr>
    <td><img src="{{ asset('img/'.$articulo->img) }}" alt="{{$arculo->img}}" width="400" height="400"></td>
    <td><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Descrpicion:</h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $articulo->des }}
    <br><br><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Categoria:</h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $articulo->categoria }}
    <br><br><h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tipo:</h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $articulo->tipo }}</p></td>
    <td></td>
    </tr>
    ...
    <tr>
      <td></td>
      <td></td>
      <td><div class="precio-col-comprar">
      <a >Comprar</a>
      </div>
      </td>
    </tr>
