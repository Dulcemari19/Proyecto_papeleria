     ...
     <br>
      ...
      <div id="tabla-precios">
        ...
        <div class="precio-col">
         ...
         <h3>120 MXN</h3>
         <p>mini set  / MI ALEGRÍA</p>
         </div>
        
        <div class="precio-col-features">
            <center><img src="assets/img/edad/e34.jpg" alt="" width="180" height="180"></center>
            <p>incluye varios colores</p>
            <p>No daña tu piel</p>
         </div>
        ...
        <div class="precio-col">
         <div class="precio-col-header">
         <h3>100 MXN</h3>
         <p>Muñeco de acción / MATEL</p>
         </div>
        
        <div class="precio-col-features">
          <center><img src="assets/img/edad/e35.jpg" alt="" width="180" height="180"></center>
         <p>Desarrollo de la imaginación</p>
         <p> Incluye un pulpo</p>
         </div>
        ...
        <div class="precio-col">
         <div class="precio-col-header">
         <h3>60 MXN</h3>
         <p> Elastic boy /  NATUR-PLAY</p>
         </div>
        
        <div class="precio-col-features">
          <center><img src="assets/img/edad/e36.jpg" alt="" width="215" height="180"></center>
         <p>Se estira hasta 3 metros </p>
         <p>Resistente al agua y fuego</p>
         </div>
        ...
        <div id="tabla-precios">
          ...
          <div class="precio-col">
           <div class="precio-col-header">
           <h3>135 MXN</h3>
           <p>Casita 101 dálmatas / MATEL</p>
           </div>
          
          <div class="precio-col-features">
            <center><img src="assets/img/edad/e28.jpg" alt="" width="210" height="180"></center>
              <p> Contiene 101 perritos</p>
              <p>Fácil de armar</p>
           </div>
          ...
          <div class="precio-col">
           <div class="precio-col-header">
           <h3>45 MXN</h3>
           <p>Pistolas de dardos / NERF</p>

           </div>
          
          <div class="precio-col-features">
            <center><img src="assets/img/edad/e29.jpg" alt="" width="180" height="180"></center>
           <p>Contine 32 dardos</p>
           <p> Alcance a una distancia de 20 metros</p>
           </div>
          ...
          <div class="precio-col-features">
            <center><img src="assets/img/edad/e30.jpg" alt="" width="210" height="180"></center>
          ...
          <div id="tabla-precios">
            ...
            <div class="precio-col">
             <div class="precio-col-header">
             <h3>69 MXN</h3>
             <p>Alas de mariposa / BARBIE</p>
             </div>
            
            <div class="precio-col-features">
              <center><img src="assets/img/edad/e32.jpg" alt="" width="180" height="180"></center>
             <p>Miden 1 metro por ala</p>
             <p>  Diferentes colores y tamaños</p>
             </div>
            ...
            <div class="precio-col-features">
              <center><img src="assets/img/edad/e33.jpg" alt="" width="180" height="180"></center>
             <p>León con música y sonido</p>
             <p>Su melena cambia de color</p>
             </div>
