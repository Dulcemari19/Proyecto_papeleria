...
<head>
  ...
  <title>Categorías / Muñecas y figuras de acción</title>
...
<body>
  ...
  <section class="testimonios">
    <div class="testimonios-title">
     <h2>Muñecas y figuras de acción</h2>
     <hr>
    </div>
    <br>
     <br>
         ...
         <div id="tabla-precios">
            ...
            <div class="precio-col">
             <div class="precio-col-header">
                <h3>100 MXN</h3>
                <p>Sonido Susaneta / BARBIE </p>
                </div>
               
               <div class="precio-col-features">
                   <center><img src="assets/img/edad/e10.jpg" alt="" width="180" height="180"></center>
                   <p>Muñeca con sonidos musicales</p>
                   <p>Con más de 30 canciones </p>
                </div>
